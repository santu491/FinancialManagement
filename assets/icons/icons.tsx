...
export const DeleteIcon = ({width = 24, height = 24, color = COLOR.BLUE}) => (
  <Svg width={width} height={height} viewBox="0 0 24 24" fill="none">
    <Path
      d="M3 6h18M9 6V4a2 2 0 012-2h2a2 2 0 012 2v2m4 0v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6h14zM10 11v6M14 11v6"
      stroke={color}
      strokeWidth={2}
      strokeLinecap="round"
